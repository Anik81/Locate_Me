...
public class hospitalNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_number);
        ...
        profileToSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent MyProfileToSetting = new Intent(hospitalNumber.this, Contacts.class);
